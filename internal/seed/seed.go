	...
	gundemArticles := []models.Article{
		{
			...
			FeaturedImage: "/uploads/articles/istanbul-su-kesintisi.jpg",
			AuthorID:      users[0].ID,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/vergi-duzenlemesi.jpg",
			AuthorID:      users[1].ID,
			CategoryID:    categories[0].ID,
			Status:        "published",
			ViewCount:     95,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/yagis-uyarisi.jpg",
			AuthorID:      users[1].ID,
			CategoryID:    categories[0].ID,
			Status:        "published",
			ViewCount:     85,
	...
	ekonomiArticles := []models.Article{
		{
			...
			FeaturedImage: "/uploads/articles/dolar-rekor.jpg",
			AuthorID:      users[0].ID,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/merkez-bankasi.jpg",
			AuthorID:      users[1].ID,
			CategoryID:    categories[1].ID,
			Status:        "published",
			ViewCount:     180,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/asgari-ucret.jpg",
			AuthorID:      users[0].ID,
			CategoryID:    categories[1].ID,
			Status:        "published",
			ViewCount:     160,
	...
	sporArticles := []models.Article{
		{
			...
			FeaturedImage: "/uploads/articles/galatasaray-fenerbahce.jpg",
			AuthorID:      users[1].ID,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/nba-transfer.jpg",
			AuthorID:      users[1].ID,
			CategoryID:    categories[2].ID,
			Status:        "published",
			ViewCount:     210,
		...
		},
		{
			...
			FeaturedImage: "/uploads/articles/milli-takim.jpg",
			AuthorID:      users[0].ID,
			CategoryID:    categories[2].ID,
			Status:        "published",
			ViewCount:     185,
